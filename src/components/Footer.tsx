    ...
    <footer className="bg-slate-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            {/* Policies — Meta Commerce eligibility requires Privacy, Returns,
                and Shipping to be visible from the site. Terms is recommended
                by Meta and required by most payment processors. */}
            <h4 className="text-lg font-semibold mb-4">Customer Care</h4>
            <ul className="space-y-2">
              <li><Link href="/returns" className="text-slate-400 hover:text-white transition-colors">Return Policy</Link></li>
              ...
              <li className="pt-3 border-t border-slate-800 mt-3 text-slate-400 text-sm">
                <a href="mailto:dan@specialtybuilt.com" className="hover:text-white transition-colors">
                  dan@specialtybuilt.com
                </a>
              </li>
